...
export class ChartsComponent implements OnInit {
  ...
  // Firebase Chart data initialize
  getCollection() {
    this.chartService.getChartData().subscribe(res => {
      this.firebaseData = res;
      this.chartInitialize('firebaseChartDiv', this.firebaseData); //Firebase chart
    });
  }

  // Chart Initialize
  chartInitialize(chartType: string, chartData: []) {
  ...
  ngOnInit(): void {
    ...
    this.chartInitialize('chartdiv', this.staticData);

    //Config Firebase chart
    this.getCollection();
  }
